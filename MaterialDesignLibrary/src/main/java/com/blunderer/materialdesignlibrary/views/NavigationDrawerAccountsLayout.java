        ...
        if (secondAccount.usePictureUrl()) {
            secondAccount.getPictureUrl().into(new SimpleTarget<GlideDrawable>() {
                ...
                public void onResourceReady(GlideDrawable resource, GlideAnimation<? super GlideDrawable> glideAnimation) {
                    ...
                    mSecondPicture.setScaleType(ImageView.ScaleType.FIT_CENTER);
                    mSecondPictureProgressBar.setVisibility(GONE);
                }

            });
        } else {
            mSecondPicture.setImageDrawable(secondAccount.getPictureResource());
            mSecondPicture.setScaleType(ImageView.ScaleType.FIT_CENTER);
        }
        ...
        if (thirdAccount.usePictureUrl()) {
            thirdAccount.getPictureUrl().into(new SimpleTarget<GlideDrawable>() {
                ...
                public void onResourceReady(GlideDrawable resource, GlideAnimation<? super GlideDrawable> glideAnimation) {
                    ...
                    mThirdPictureProgressBar.setVisibility(GONE);
                    mThirdPicture.setScaleType(ImageView.ScaleType.FIT_CENTER);
                }

            });
        } else {
            mThirdPicture.setImageDrawable(thirdAccount.getPictureResource());
            mThirdPicture.setScaleType(ImageView.ScaleType.FIT_CENTER);
        }
    }
