...
public class SingleProductView extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < AppController.getInstance().getProductImageURLList(productData).size(); i++) {
            ...
            imageSlide.setOnSliderClickListener(new BaseSliderView.OnSliderClickListener() {
                ...
                public void onSliderClick(BaseSliderView baseSliderView) {
                    View view = View.inflate(SingleProductView.this, R.layout.zoom_image_view, null);
                    ...
                    new AlertDialog.Builder(SingleProductView.this).setView(view).create().show();
                }
            });
        ...
        makeMyMatch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SingleProductView.this, MatchMakerActivity.class).putExtra("productID", productData.getProductID()));
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SingleProductView.this, BuyProductCOD.class).putExtra("productID", productData.getProductID()).putExtra("mode", "single"));
            }
        });
        ...
        cartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (AppController.getInstance().isLoggedIn()) {
                    if (!AppController.getInstance().getUserProfile().getUserCart().contains(productData.getProductID())) {
                        AppController.getInstance().showMaterialProgress(SingleProductView.this);
                        new CartOperation(SingleProductView.this, true, productData.getProductID(), new onCartCallBackListener() {
                            @Override
                            public void onCartCallBack(String response) {
                                if (response.equalsIgnoreCase("errorOccurred")) {
                                    ...
                                    new GetProfile(SingleProductView.this, AppController.getInstance().getUserInfo().getEmail(), new onProfileLoadedListener() {
                                        @Override
                        ...
                        AppController.getInstance().showMaterialProgress(SingleProductView.this);
                        new CartOperation(SingleProductView.this, false, productData.getProductID(), new onCartCallBackListener() {
                            @Override
                            public void onCartCallBack(String response) {
                                if (response.equalsIgnoreCase("errorOccurred")) {
                                    Snackbar.make(findViewById(R.id.root), "Cannot connect to server", Snackbar.LENGTH_SHORT).show();
    ...
    protected int getContentView() {
        return R.layout.activity_single_product_view;
    }
