...
import com.thelogicalcoder.viazene.Fragment.ViewAllServicesFragment;
...
public class ViewAllServices extends AppCompatActivity implements ScrollTabHolder, ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarIcon = (TextView) findViewById(R.id.toolBarIcon);
        ...
        switch (position) {
            case 0:
                mHeaderLogo.setText(AppController.getInstance().getServiceCategories().get(position).toUpperCase());
                mHeaderPicture.setResourceId(R.drawable.mehndi_banner_activity);
                toolbarIcon.setText(AppController.getInstance().getServiceCategories().get(position).toUpperCase());
                break;
            case 1:
                mHeaderLogo.setText(AppController.getInstance().getServiceCategories().get(position).toUpperCase());
                mHeaderPicture.setResourceId(R.drawable.tatto_banner_activity);
                toolbarIcon.setText(AppController.getInstance().getServiceCategories().get(position).toUpperCase());
                break;
            case 2:
                mHeaderLogo.setText(AppController.getInstance().getServiceCategories().get(position).toUpperCase());
                mHeaderPicture.setResourceId(R.drawable.imageconsultant_banner_activity);
                toolbarIcon.setText(AppController.getInstance().getServiceCategories().get(position).toUpperCase());
                break;
            case 3:
                mHeaderLogo.setText(AppController.getInstance().getServiceCategories().get(position).toUpperCase());
                mHeaderPicture.setResourceId(R.drawable.bridal_banner_activity);
                toolbarIcon.setText(AppController.getInstance().getServiceCategories().get(position).toUpperCase());
                break;
            case 4:
                mHeaderLogo.setText(AppController.getInstance().getServiceCategories().get(position).toUpperCase());
                mHeaderPicture.setResourceId(R.drawable.photoshoot_banner_activity);
                toolbarIcon.setText(AppController.getInstance().getServiceCategories().get(position).toUpperCase());
                break;
            case 5:
                mHeaderLogo.setText(AppController.getInstance().getServiceCategories().get(position).toUpperCase());
                mHeaderPicture.setResourceId(R.drawable.massage_banner_activity);
                toolbarIcon.setText(AppController.getInstance().getServiceCategories().get(position).toUpperCase());
                break;
        }
...
//        getSupportActionBar().setTitle(mSpannableString);
    ...
    private TextView getActionBarIconView() {
        ...
        return (TextView) findViewById(R.id.toolBarIcon);
    }
    ...
    public class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ScrollTabHolderFragment fragment = (ScrollTabHolderFragment) ViewAllServicesFragment.newInstance(position);
