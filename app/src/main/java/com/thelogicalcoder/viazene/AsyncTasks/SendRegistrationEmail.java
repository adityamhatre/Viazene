 ...
 */
public class SendRegistrationEmail extends AsyncTask<Void, Void, Void> {
   ...
   // private ProgressDialog progressDialog;
    ...
    public SendRegistrationEmail(Context context, String email, String password, String user, onAsyncCallBack onAsyncCallBack) {
        SendRegistrationEmail.context = context;
    ...
    protected Void doInBackground(Void... params) {
        try {
            URL url = new URL(Server.SEND_REGISTRATION_EMAIL + "?" + System.currentTimeMillis());
            ...
            if (httpURLConnection.getResponseCode() == 200) {
                ...
                System.out.println("sendRegEmail: " + response);
