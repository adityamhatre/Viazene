 ...
 */
public class BuyServiceCODAsync extends AsyncTask<Void, Void, Void> {
    ...
    public BuyServiceCODAsync(Context context, ServiceData serviceData, String details, onAsyncCallBack onAsyncCallBack) {
        BuyServiceCODAsync.context = context;
        ...
        postParams.put("details", details.replace("\n","<br>"));
    }
    ...
    protected Void doInBackground(Void... params) {
        try {
            URL url = new URL(Server.BUY_SERVICE + "?" + System.currentTimeMillis());
            ...
            if (httpURLConnection.getResponseCode() == 200) {
                ...
                System.out.println("buyService: " + response);
