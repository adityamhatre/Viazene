 ...
 */
public class WallLiker extends AsyncTask<Void, Void, Void> {
    ...
    public WallLiker(Context context, Boolean likeMode, String productID, String wallID, onWallCallBackListener onWallCallBackListener) {
    ...
    protected Void doInBackground(Void... params) {
        try {
            URL url;
            if (likeMode) {
                url = new URL(Server.WALL_LIKE + "?" + System.currentTimeMillis());
            } else {
                url = new URL(Server.WALL_UNLIKE + "?" + System.currentTimeMillis());
            }
            ...
            if (httpURLConnection.getResponseCode() == 200) {
                ...
                System.out.println("wallLiker: " + response);
