package com.thelogicalcoder.viazene.Volley;

/**
 * Created by Aditya on 002, 2 May 2015.
 */
                    ...
                    public void onErrorResponse(VolleyError error) {
                        if (mErrorImageId != 0) {
                            try {
                                ...
                                Toast.makeText(getContext(), "Some strange error occured", Toast.LENGTH_SHORT).show();
                                AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
                                builder.setTitle("Oops");
                                builder.setMessage("Error occurred.\nThough this error is handled, it is recommended that you restart this App.");
                                builder.setPositiveButton("Yes, I want to restart", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        System.exit(0);
                                    }
                                });
                                builder.setNegativeButton("No, I won't", null);
                                builder.create().show();
                                System.gc();
                            }
                        }
